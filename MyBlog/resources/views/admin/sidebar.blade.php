<nav id="sidebar">
    ...
    <ul class="list-unstyled">
        ...
        <li class="active"><a href="{{route('approved_comments')}}"> <i class="fas fa-pencil-alt"></i>Reviews</a></li>

        <li class="active"><a href="{{route('users')}}"> <i class="fas fa-users"></i>Users </a></li>
