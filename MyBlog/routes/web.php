...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/changeName/{id}', [AdminController::class, 'showChangeNameForm'])->name('changeName');
    Route::post('/updateName/{id}', [AdminController::class, 'updateName'])->name('updateName');
});
